...
const AssetSwapsAdd = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    purchase_price: "", // Add purchase price field
    rent_price_per_month: "", // Add monthly rent field
  });
    ...
    productsData.forEach((product) => {
      ...
      assetIdsToInclude.forEach((assetId) => {
        assets.push({
          ...
          purchase_price: product.product.purchase_price, // Add purchase price
          rent_price_per_month: product.product.rent_price_per_month, // Add monthly rent price
        });
      });
    });

    return assets;
  }, [productsData, showWarehouseAssets, showClientAssets]);
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "asset_id") {
      ...
      setFormData((prev) => ({
        ...
        purchase_price: selectedAsset ? selectedAsset.purchase_price : "", // Store purchase price
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        purchase_price: formData.purchase_price, // Add purchase price to payload
        rent_price_per_month: formData.rent_price_per_month, // Add monthly rent to payload
      };

      const response = await fetch(`${API_URL}/asset-swaps/create`, {
        method: "POST",
        headers: {
  ...
  return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        <h1 style={titleStyle}>Create Asset Scrap</h1>
      </div>
...
// Existing Styles (keep the same as before)
