...
const RolesEditPage = () => {
    ...
    const fetchRoleData = async () => {
      try {
        ...
        setFormData({
          ...
          activeStatus: role.is_active ?? true,
          userDefaultAccess: role.user_default_access ?? false,
        });
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.error || "Failed to update role. Please try again."
      );
    } finally {
  ...
  return (
    <div style={containerStyle}>
      {/* Breadcrumb */}
      <div style={breadcrumbStyle}>Masters / Role / Edit Role</div>
      ...
      <div style={formContainerStyle}>
        ...
        <div style={cardStyle}>
          <div style={cardHeaderContainerStyle}>
            ...
            <h3 style={cardHeaderStyle}>Edit Role:</h3>
          </div>
        ...
        {/* <div style={userAccessHeaderStyle}>
          ...
          <div style={toggleContainerStyle}>
            <div
              ...
              style={{
                ...toggleStyle,
                backgroundColor: formData.userDefaultAccess
                  ? "#2563eb"
                  : "#d1d5db",
              }}
            >
              <div
                style={{
                  ...toggleCircleStyle,
                  transform: formData.userDefaultAccess
                    ? "translateX(24px)"
                    : "translateX(2px)",
                }}
              />
      ...
      <div style={buttonContainerStyle}>
        ...
        <button
          ...
          onMouseEnter={(e) =>
            !isSubmitting && (e.target.style.backgroundColor = "#1d4ed8")
          }
          onMouseLeave={(e) =>
      ...
      {showSuccessSnackbar && (
        <div style={snackbarStyle}>
          <div style={snackbarContentStyle}>
            ...
            <span style={snackbarTextStyle}>Role updated successfully!</span>
            <button
...
// Styles (same as RolesAddPage with minor adjustments)
