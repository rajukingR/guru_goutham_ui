...
const ProductTemplateEdit = () => {
  // Dummy product data to simulate an existing product being edited
  const dummyProductData = {
    category: 'Assembled Desktops',
    image: 'https://via.placeholder.com/300',
    productName: 'Premium Gaming Desktop',
    brand: 'HP',
    model: 'Gamer-Xtreme-2023',
  ...
  const [formData, setFormData] = useState(dummyProductData);
  const [previewImage, setPreviewImage] = useState(dummyProductData.image);

  useEffect(() => {
    setFormData(dummyProductData);
    setPreviewImage(dummyProductData.image);
  }, []);
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        <div style={headerStyle}>
          ...
          <div>
            <h3 style={titleStyle}>Edit Product Template</h3>
            <p style={subtitleStyle}>Update the details of this product template</p>
          </div>
        </div>
        ...
        <div style={buttonContainerStyle}>
          ...
          <button style={updateBtnStyle}>Update Product</button>
        </div>
      </div>
    </div>
  );
