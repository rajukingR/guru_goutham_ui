...
const BrandsPageEditLayout = () => {
  ...
  useEffect(() => {
    // Load existing brand data here
    setForm({
      brandNumber: "BR123",
      brandName: "Coca Cola",
      description: "Popular beverage brand",
      active: true,
    });
  }, []);
  ...
  const handleSubmit = () => {
    console.log("Updated Brand:", form);
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        <div style={cardHeaderContainerStyle}>
          ...
          <h3 style={cardHeaderStyle}>Edit Brand</h3>
        </div>
        ...
        <div style={buttonContainerStyle}>
          ...
          <button style={updateBtnStyle} onClick={handleSubmit}>
            Update
          </button>
        </div>
      </div>
...
const Field = ({ label, type = 'text', value = '', name, onChange }) => (
  <div style={{
    display: 'flex',
    flexDirection: 'column',
  }}>
