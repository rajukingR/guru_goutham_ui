...
const ItemMasterPageLayoutEdit = () => {
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        <div style={cardHeaderContainerStyle}>
          <div style={iconStyle}>📝</div>
          <h3 style={cardHeaderStyle}>Edit Item Master</h3>
        </div>
        <div style={fieldsGridStyle}>
          <Field label="Product Category" type="select" value="Laptop" />
          <Field label="Item Name" type="text" value="MacBook Pro" />
          <Field label="Description" type="text" value="16-inch, M2 Chip" />
...
export default ItemMasterPageLayoutEdit;