...
const ServiceMaintenanceAdd = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // 3. Send POST request
      const response = await fetch(`${API_URL}/service-charges/create`, {
        method: "POST",
        headers: {
      ...
      // 4. Success
      showSnackbar("Service Charges created successfully", "success");
      setTimeout(() => {
  ...
  return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        <h1 style={titleStyle}>Create Service Maintenance</h1>
      </div>
...
export default ServiceMaintenanceAdd;
