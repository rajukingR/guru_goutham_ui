...
const GrnEditForm = () => {
  ...
  useEffect(() => {
    setFormData({
      grnId: 'GRN-0001',
      grnTitle: 'Return of Defective Products',
      customer: 'ABC Corp',
      ...
      informedPersonPhone: '9988776655',
      returnerName: 'Jane Smith',
      returnerPhone: '8877665544',
      receiverName: 'Ravi Kumar',
      receiverPhone: '7766554433',
      description: 'Returning defective items received in last shipment.',
      ...
      <div style={formContainerStyle}>
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldsGridStyle}>
            ...
            <SelectField label="Select Customer" value={formData.customer} onChange={(value) => handleInputChange('customer', value)} options={[{ value: '', label: 'Select a customer' }, { value: 'ABC Corp', label: 'ABC Corp' }]} />
            <Field label="Customer ID*" placeholder="Enter Customer ID" value={formData.customerId} onChange={(value) => handleInputChange('customerId', value)} />
            <Field label="Email ID*" type="email" placeholder="Enter Email ID" value={formData.email} onChange={(value) => handleInputChange('email', value)} />
            <Field label="Phone No*" type="tel" placeholder="Enter Phone Number" value={formData.phone} onChange={(value) => handleInputChange('phone', value)} />
            ...
            <Field label="GRN Created By" value="rounder" readOnly={true} />
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldsGridStyle}>
            ...
            <Field label="Informed Person Phone No*" type="tel" placeholder="Enter Phone Number" value={formData.informedPersonPhone} onChange={(value) => handleInputChange('informedPersonPhone', value)} />
            ...
            <Field label="Returner Phone No" type="tel" placeholder="Enter Phone Number" value={formData.returnerPhone} onChange={(value) => handleInputChange('returnerPhone', value)} />
            ...
            <Field label="Receiver Phone No*" type="tel" placeholder="Enter Phone Number" value={formData.receiverPhone} onChange={(value) => handleInputChange('receiverPhone', value)} />
          ...
          <div style={textareaContainerStyle}>
            ...
            <textarea placeholder="Enter Description" style={textareaStyle} value={formData.description} onChange={(e) => handleInputChange('description', e.target.value)} />
          </div>
        </div>
      </div>
...
// Reusable components and styles (same as in GrnAddForm)
