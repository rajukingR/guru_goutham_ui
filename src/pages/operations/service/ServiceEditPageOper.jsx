...
const ServiceEditPageOper = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Updated form submitted:', formData);
  };

  const handleCancel = () => {
    // Reset to dummy data again
    window.location.reload();
  };

  return (
    <div style={containerStyle}>
      <h2 style={headingStyle}>Edit Service</h2>
...
export default ServiceEditPageOper;
