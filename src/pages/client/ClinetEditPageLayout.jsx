...
const ClinetEditPageLayout = () => {
  const [formData, setFormData] = useState({
    clientId: 'CL001',
    clientName: 'John Doe',
    companyName: 'ABC Corporation',
    productCost: '1000',
    rentalStartDate: '2023-03-15',
    rentalReturnDate: '2023-03-20',
  ...
  const handleCancel = () => {
    // Add logic to cancel editing
  };

  return (
    <div style={containerStyle}>
      <h2 style={headingStyle}>Edit Client Details</h2>
...
const Field = ({ label, placeholder, type = 'text', name, value, onChange, style, disabled = false }) => (
...
export default ClinetEditPageLayout;