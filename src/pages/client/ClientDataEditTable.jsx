...
const ClientDataEditTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          rentalEnd: data.rental_return_date || null,
          email: data.email || "",
          address: data.address || "",
          country: data.country || "",
          state: data.state || "",
          city: data.city || "",
          active: data.active_status || false,
        });
      } catch (err) {
        setSnackbar({
          open: true,
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (response.ok) {
        ...
        throw new Error(error.message || "Failed to update client data.");
      }
    } catch (err) {
      setSnackbar({
        open: true,
  ...
  // same styles as ClientDataAddTable.jsx
      ...
      <div style={containerStyle}>
        ...
        <div style={cardStyle}>
          <div style={cardHeaderContainerStyle}>
            ...
            <h3 style={cardHeaderStyle}>Edit Client Details</h3>
          </div>
...
export default ClientDataEditTable;
