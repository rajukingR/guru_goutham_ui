      ...
      <div style={formContainerStyle}>
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldsGridStyle}>
            <Field label="Goods Receipt ID" placeholder="Enter Goods Receipt ID" />
            <Field label="Vendor Invoice Number" placeholder="Enter Vendor Invoice Number" />
            <Field label="Purchase Order Details" type="select" placeholder="Select Purchase Order" />
            <Field label="Purchase Order ID" placeholder="Enter Purchase Order ID" />
            <Field label="Purchase Order Status" value="Pending" disabled />
            <Field label="Goods Receipt Date" type="date" />
  ...
  <div style={fieldContainerStyle}>
    ...
    {type === 'select' ? (
      <div style={selectWrapperStyle}>
        <select style={selectStyle} disabled={disabled} defaultValue="">
