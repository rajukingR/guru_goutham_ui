...
const AssetModificationForm = () => {
  ...
  useEffect(() => {
    const fetchAssets = async () => {
      try {
        const response = await fetch(`${API_URL}/asset-modification/product_id/${product_id}`);
  ...
  return (
    <div style={containerStyle}>
      <h1>Asset Modification Request</h1>
<form id="modificationForm" onSubmit={handleSubmit} style={formContainerStyle}>
...
const Field = ({ label, placeholder, type = 'text', value, onChange, disabled = false, required = false }) => (
  <div style={fieldContainerStyle}>
